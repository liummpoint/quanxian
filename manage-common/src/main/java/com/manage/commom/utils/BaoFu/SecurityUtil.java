...
//		str = str.replaceAll(" ", "+");
	...
	public static String desEncrypt(String source, String desKey) throws Exception {
		try {
			...
			throw new Exception("DES鍔犲瘑鍙戠敓閿欒", e);
		}
	}
	...
	public static String desDecrypt(String source, String desKey) throws Exception {
		...
		try {
			...
			throw new Exception("DES瑙ｅ瘑鍙戠敓閿欒", e);
		}
	}
	...
	public static byte[] threeDesEncrypt(byte[] src, byte[] keybyte) throws Exception {
		try {
			...
			throw new Exception("3DES鍔犲瘑鍙戠敓閿欒", e);
		}
	}
	...
	public static byte[] threeDesDecrypt(byte[] src, byte[] keybyte) throws Exception {
		try {
			...
			throw new Exception("3DES瑙ｅ瘑鍙戠敓閿欒", e);
		}
	}
	...
	public static void main(String[] args) throws Exception {
		String str = "鏁版嵁鍔犲瘑鐨勫熀鏈繃绋嬪氨鏄鍘熸潵涓烘槑鏂囩殑鏂囦欢鎴栨暟鎹寜鏌愮绠楁硶杩涜澶勭悊锛屼娇鍏舵垚涓轰笉鍙鐨勪竴娈典唬鐮侊紝閫氬父绉颁负鈥滃瘑鏂団�濓紝"
				+ "浣垮叾鍙兘鍦ㄨ緭鍏ョ浉搴旂殑瀵嗛挜涔嬪悗鎵嶈兘鏄剧ず鍑烘湰鏉ュ唴瀹癸紝閫氳繃杩欐牱鐨勯�斿緞鏉ヨ揪鍒颁繚鎶ゆ暟鎹笉琚潪娉曚汉绐冨彇銆侀槄璇荤殑鐩殑銆� " 
				+ "璇ヨ繃绋嬬殑閫嗚繃绋嬩负瑙ｅ瘑锛屽嵆灏嗚缂栫爜淇℃伅杞寲涓哄叾鍘熸潵鏁版嵁鐨勮繃绋嬨��";
		str+=str;str+=str;str+=str;
		String PWD = "SecurityUtil.PWD";
		System.out.println("鍘熸枃:[" + str.length() + "]" + str);
		System.out.println("==MD5===============");
		System.out.println(MD5(str));
		System.out.println("==Base64============");
		String strBase64 = Base64Encode(str);
		System.out.println("鍔犲瘑:[" + strBase64.length() + "]" + strBase64);
		System.out.println("瑙ｅ瘑:" + Base64Decode(strBase64));
		System.out.println("==Aes============");
		String strAes = AesEncrypt(str, PWD);
		System.out.println("鍔犲瘑:[" + strAes.length() + "]" + strAes);
		System.out.println("瑙ｅ瘑:" + AesDecrypt(strAes, PWD));
		System.out.println("==Des==============");
		String strDes = desEncrypt(str, PWD);
		System.out.println("鍔犲瘑:[" + strDes.length() + "]" + strDes);
		System.out.println("瑙ｅ瘑:" + desDecrypt(strDes, PWD));
		System.out.println("==3Des==============");
		String str3Des = threeDesEncrypt(str, PWD);
		System.out.println("鍔犲瘑:[" + str3Des.length() + "]" + str3Des);
		System.out.println("瑙ｅ瘑:" + threeDesDecrypt(str3Des, PWD));
