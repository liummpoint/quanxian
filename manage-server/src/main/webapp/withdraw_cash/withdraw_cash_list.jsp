...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 申请提现 <span
        class="c-gray en">&gt;</span> 申请提现列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px"
...
<c:if test="${fn:contains(sessionScope.role.websiteRole,sessionScope.user_add)}">
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a
            ...
            class="Hui-iconfont">&#xe600;</i> 申请提现</a></span></div>
</c:if>
...
<script type="text/javascript">
        ...
        var _table = $table.dataTable($.extend(true, {}, CONSTANT.DATA_TABLES.DEFAULT_OPTION, {
            ...
            "createdRow":
                ...
                function (row, data, index) {
                    ...
                    var update_html='<a style="text-decoration:none;color: cornflowerblue;" onClick="editInfo(' + data.withdrawCashId+')" >修改</a><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>'
                    var delete_html='<a style="text-decoration:none;color: cornflowerblue;" onClick="deleteInfo('+ data.withdrawCashId+')" >删除</a><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>'
    ...
    function editInfo(id) {
        var url = "<%=basePath%>withdraw_cash/withdraw_cash_update.jsp?id=" + id;
        layer_show('修改申请提现', url, '', '510');
    }
    function addInfo() {
        var url = "<%=basePath%>withdraw_cash/withdraw_cash_insert.jsp";
        layer_show('新增申请提现', url, '', '510');
    }

    function deleteInfo(id) {

        if(confirm("确定要删除吗？")){
            var url = 'withdrawCash/deleteWithdrawCash.do';
            $.ajax({
                type: "post",
                url: '<%=basePath%>' + url,
                data: {"withdrawCashId": id},
                dataType: "json",
                success: function (data) {
                    alert(data.msg)
