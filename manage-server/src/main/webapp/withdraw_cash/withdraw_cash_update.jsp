...
<script type="text/javascript">
    $(function () {
        ...
        $.ajax({
            ...
            dataType: 'json',
            async: false,
            url: '<%=basePath%>withdrawCash/selectById.do',
            success: function (data) {
                $("#realname").val(data.data.realname);
                $("#idCardNo").val(data.data.idCardNo);
                $("#bankCardNo").val(data.data.bankCardNo);
                $("#openCard").val(data.data.openCard);
        ...
        $("#form-member-add").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    ...
                    url: '<%=basePath%>withdrawCash/updateWithdrawCash.do',
