...
public class MD5 {
	...
	/**
	 * 直接MD5的算法不做业务中使用 加盐的算法才作为真正的MD5业务方法
	 * 
	 * @param inbuf
	 * @return
	 */
	...
	public static void main(String args[]) {
		System.out.println(MD5.encodeByMd5AndSaltWithJs("AC9A2D8AD40FA315A466ECA349A3F54F"));
	}

	public static String getDigest(Map<String, String> map, String key, String charset){
